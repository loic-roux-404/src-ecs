...
if(difficultyBlock !== null){
    const difficulty: string|null = difficultyBlock.getAttribute("data-difficulty");
    const difficultyLvl: HTMLCollectionOf<HTMLElement> = document.getElementsByClassName("listDifficulty") as HTMLCollectionOf<HTMLElement>;
